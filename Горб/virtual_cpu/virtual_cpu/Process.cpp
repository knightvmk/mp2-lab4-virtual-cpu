...
void main()
{
	...
	printf(" Текущая частота процессоров в кластере: %i MHz\n\n", cpu_freq);
	...
	printf(" Замечание: Если вы желаете прервать процесс и посмотреть статистику нажмите любую клавишу в процессе выполнения\n");
	system("pause");
